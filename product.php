<?php 
    ...
    if($product_id >0){
        $get_product = get_product($conn,'','',$product_id); // limit 4 means $limit
    }else{
        ?>
        <script>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            ...
                            <div class="cart__btn"><a href="javascript:void(0)" onclick="manage_cart('<?php echo $get_product['0']['id']?>','add')">Add Cart</a></div>
                        </div>
                    </div>
                </div>
            </div>
